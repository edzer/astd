...
E2. In the PM10 data we looked at last week (`data(air, package = "spacetime")`), investigate whether there is a weekly or monthly cyclic trend present in the time series for the first station.
