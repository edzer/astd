...
For combining tiles that do not line up (mosaic, warp) into a regular raster, package [gdalcubes](https://cran.r-project.org/web/packages/gdalcubes/index.html) can be used.
