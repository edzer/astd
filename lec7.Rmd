...
* deal with a problem for which analysing spatiotemporal data is needed to solve it
...
* be submitted as a .zip file with the report in an R-Markdown file (or similar), but in any case include the data, and be easily reproducible, as well as include the final form (either html or pdf)
